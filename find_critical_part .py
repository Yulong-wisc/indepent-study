...
for part in parts:
    ...
    #get the length, width of the box and their ratio
    box_length.append(bounding_box)
    box_width.append(bounding_box)
    box_ratio.append(box_length[part]/box_width[part])
...
#2. the value of modification
box_diference=[]
for part in parts:
    box_diference.append(box_length[part]-box_width[part])
    pass
...
num_points_total =
for part in parts:
    part_portion.append(/num_points_total)
    pass
