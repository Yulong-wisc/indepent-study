...
while (loop_time < max_num_loops):
    ...
    for part in parts:
        ...
        part_id += 1"""
    for i in range(len(parts)):
        objFilePath = "my_temp_part" + str(i) + ".obj"
        with open(objFilePath) as file:
            points = []
            face = []
            while 1:
        ...
        center, radius, point1, point2 = turnmesh2sphere.outersphere(points)
        print('center:', center, 'radius:', radius)
        Rad = turnmesh2sphere.Turnmeshtosphere(points, center, radius)
